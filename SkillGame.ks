...
[emb exp="tf.Sample"]を選べ
[glink  color="blue"  storage="scene1.ks"  size="20"  x="260"  width="400"  y="100"  text="赤"  exp="tf.Answer='赤'" storage="SkillGame.ks" target="*Kotae"  ]
[glink  color="blue"  storage="scene1.ks"  size="20"  x="260"  width="400"  y="170"  text="黒"  exp="tf.Answer='黒'" storage="SkillGame.ks" target="*Kotae"  ]
[glink  color="blue"  storage="scene1.ks"  size="20"  x="260"  width="400"  y="240"  text="黄"  exp="tf.Answer='黄'" storage="SkillGame.ks" target="*Kotae"  ]
[glink  color="blue"  storage="scene1.ks"  size="20"  x="260"  width="400"  y="310"  text="白"  exp="tf.Answer='白'" storage="SkillGame.ks" target="*Kotae"  ]
[glink  color="blue"  storage="scene1.ks"  size="20"  x="260"  width="400"  y="380"  text="青"  exp="tf.Answer='青'" storage="SkillGame.ks" target="*Kotae"  ]
[wait time=3000]
[jump target="*timeout"]
[s]
